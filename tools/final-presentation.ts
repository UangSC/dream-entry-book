...
import { AI_CONTENT_NOTICE } from '../src/runtime/contentNotice';
...
export const finalPresentation: Presentation = {
  ...
  tags: ['三线八终幕', '山野来信'], contentNote: '包含亲人离别、食心、暴力与牺牲。',
  usageNotice: AI_CONTENT_NOTICE,
  scenes: {
    ...
    BG_COTTAGE_RAIN: { label: '小院 · 雨夜', time: 'night', particles: 'rain', ambience: 'BGM_RAIN_AMBIENCE' },
    BG_FOREST_RAIN: { label: '山林 · 冷雨', time: 'night', particles: 'rain', ambience: 'BGM_FOREST_RAIN' },
